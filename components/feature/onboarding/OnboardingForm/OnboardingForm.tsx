    ...
    <div className="max-w-md mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100">
        <div className="flex items-center justify-between mb-12">
          <div className="flex flex-col w-auto h-auto">
            <h1 className="text-xl font-black uppercase text-slate-900">{t('onboarding.welcome')}</h1>
            <small className="text-blue-600 uppercase font-black">{t('app.tagline')}</small>
          </div>
          <div className="relative">
            <button
              ...
              aria-label={t('onboarding.infoAriaLabel')}
            >
      ...
      <div className="mt-8 flex justify-center gap-4 text-slate-400">
        <div className="flex flex-row justify-between items-center border rounded-xl w-40 bg-white border p-4">
          ...
          <span className="text-[10px] uppercase font-bold tracking-widest">{t('onboarding.questionsLabel')}</span>
        </div>
        {/* <div className="flex flex-row justify-between items-center border rounded-xl w-40 bg-white border p-4">
